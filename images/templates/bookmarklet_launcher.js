(function(){
    if (window.myBookmarklet !== undefined){
        ...
        document.body.appendChild(document.createElement('script')).src='https://memesbyfernanda.herokuapp.com/static/js/bookmarklet.js?r='+Math.floor(Math.random()*99999999999999999999);
    }
})();